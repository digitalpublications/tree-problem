...
---
- Πρέπει να δημιουργηθεί ένας πίνακας `$allAncestors`, ο οποίος έχει τόσες θέσεις, όσα είναι και τα `paths` (διαδρομές) που πληρούν την προϋποθεση 
...
- Οι κατηγορίες του προϊόντος (`$productCategories`) είναι έγκυρες *ΜΟΝΟ* εάν είναι φύλλα του δέντρου (βλ. και Ζητούμενο #1) και δεν είναι απαραίτητο να έχουν δοθεί όλες οι γονικές κατηγορίες (όλα τα nodes του path).
---
